...
a [new issue](https://github.com/camunda-community-hub/bpmn-spec/issues). Before creating an issue, make sure
...
a [new issue](https://github.com/camunda-community-hub/bpmn-spec/issues). Describe your idea and the
...
```
feat(ui): show visual output from test run

* generate BPMN diagram with annotations
* ...
```
